...
const Where = () => {
  return (
    <PageWrapper>
      ...
      <Repo name="NetflixAddicts" url="https://github.com/onRuntime/netflixaddicts-website" primaryLanguage="TypeScript" description="To all fans of Netflix series and movies! Find opinions, advice and more on our site!" />
