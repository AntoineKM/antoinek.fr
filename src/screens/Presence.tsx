...
const Presence = () => (
    <PageWrapper forceReadableWidth>
      ...
      called <Link href={"https://github.com/phineas/lanyard"}>Lanyard</Link> which pulls live presences from Discord and updates an API and WebSocket service. It takes {'<'}10 seconds to set up, you just have to join a Discord server!
    </p>
    </PageWrapper>
);
