...
const CompanyAnalysisSchema = z.object({
  ...
  industry: z.string().describe("The industry or sector the company operates in"),
  ...
  size: z.string().describe("Company size (startup, small, medium, large, enterprise)"),
  locations: z.array(z.string()).describe("Main office locations or countries of operation"),
});
